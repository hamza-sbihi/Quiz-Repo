...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, partialUpdateEntity, reset, updateEntity } from './choice.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CHOICE_LIST actions', async () => {
    ...
    it('dispatches FETCH_CHOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CHOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CHOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CHOICE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CHOICE actions', async () => {
      const expectedActions = [
        {
